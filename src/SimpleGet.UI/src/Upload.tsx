  ...
  private buildState(tab: Tab): IUploadState {
    ...
    switch (tab) {
      ...
      case Tab.PowerShellGet:
        name = "PowerShellGet";
        content = [
          `Register-PSRepository -Name "SimpleGet" -SourceLocation "${this.serviceIndexUrl}" -PublishLocation "${this.publishUrl}" -InstallationPolicy "Trusted"`,
          `Publish-Module -Name PS-Module -Repository SimpleGet`
        ];
